...
Gradle plugin for Cleanroom Loader development and Cleanroom-targeted mod development. The current release is `0.11.0`.
...
plugins {
    id 'com.cleanroommc.cleanroomgradle.settings' version '0.11.0'
}
```
